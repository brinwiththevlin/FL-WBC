...
def args_parser():
    ...
    parser.add_argument(
        "--nclass", type=int, default=2, help="number of image classes per client have"
    )
    parser.add_argument(
        "--nsamples",
        type=int,
    ...
    parser.add_argument(
        "--rate_unbalance", type=float, default=1.0, help="unbalance rate"
    )
    ...
    # pruning arguments
    parser.add_argument(
        "--prune_percent", type=float, default=10, help="pruning percent"
    )
    parser.add_argument(
        "--prune_start_acc", type=float, default=0.8, help="pruning start acc"
    )
    parser.add_argument(
        "--prune_end_rate", type=float, default=0.5, help="pruning end rate"
    )
    parser.add_argument("--mask_ratio", type=float, default=0.5, help="mask ratio")

    # sampling arguments
    parser.add_argument(
        "--num_samples", type=int, default=100, help="number of samples for HAR"
    )

    # malicious arguments
    parser.add_argument(
        "--num_mal_samples", type=int, default=480, help="number of malicious samples"
    )
    parser.add_argument("--mal_boost", type=int, default=1, help="malicious boosting")
    parser.add_argument("--attack_round", type=int, default=10, help="attack round")
    parser.add_argument(
    ...
    parser.add_argument(
        "--pert_strength", type=float, default=1e-4, help="perturbation strength"
    )
    parser.add_argument(
        "--tm_belta", type=float, default=0, help="belta for trimmed mean"
    )
